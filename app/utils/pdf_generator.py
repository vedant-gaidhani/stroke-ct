...
def generate_clinical_report(
    ...
    pdf.set_xy(15, 8)
    pdf.cell(0, 10, "NeuroScan AI - Clinical Stroke Detection Report", ln=True)
    ...
    pdf.multi_cell(
        180, 5,
        "This report is AI-generated and must be reviewed by a qualified radiologist before any clinical "
        "decision. Not for standalone diagnostic use. NeuroScan AI is a decision-support tool only."
    )
