...
<div style="display:flex; align-items:baseline; gap:12px;"><span style="color:#00f2fe; font-size:clamp(24px, 5vw, 48px); font-weight:800; letter-spacing:-1px;">98.5%</span><span style="color:#8892A4; font-size:clamp(12px, 2vw, 15px); font-weight:500;">Accuracy</span></div>
<div style="display:flex; align-items:baseline; gap:12px;"><span style="color:#00f2fe; font-size:clamp(24px, 5vw, 48px); font-weight:800; letter-spacing:-1px;">99.8%</span><span style="color:#8892A4; font-size:clamp(12px, 2vw, 15px); font-weight:500;">AUC Score</span></div>
